...
import numpy as np
from evaluate_extremities import (evaluate_detection_prediction, mirror_labels,
                                  scale_points)
...
def evaluate(gt_zip, prediction_zip, width=960, height=540):
    ...
    for gt_json in gt_jsons:
        ...
        confusion1, per_class_conf1, reproj_errors1 = evaluate_detection_prediction(
            img_prediction, img_groundtruth, 10
        )
        confusion2, per_class_conf2, reproj_errors2 = evaluate_detection_prediction(
            img_prediction, mirror_labels(img_groundtruth), 10
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-s",
        "--soccernet",
        default="./annotations/test_json.zip",
        type=str,
